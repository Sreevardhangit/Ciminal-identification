...
# Check if LBPHFaceRecognizer_create is in the cv2.face module
if hasattr(cv2.face, 'LBPHFaceRecognizer_create'):
    ...
    # You might want to exit the script or handle this case accordingly
    exit()

size = 2
haar_cascade = cv2.CascadeClassifier(r'D:\PROJECT\face_cascade.xml')
